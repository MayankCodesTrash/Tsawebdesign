...
export function FallingPattern({
  ...
  density = 1,
  style = {},
  overlayColor = 'rgba(251, 244, 232, 0.0)',
}) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', padding: 4, ...style }}>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div
        style={{
          ...
          backgroundImage: `radial-gradient(circle at 50% 50%, transparent 0, transparent 2px, ${overlayColor} 2px)`,
